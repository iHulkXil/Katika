  ...
  return <div className="overflow-hidden">
    <section className="relative min-h-[680px] border-b border-border/70 surface-grid">
      ...
      <div className="relative mx-auto flex min-h-[680px] max-w-[1240px] items-center px-5 pb-12 pt-16 lg:px-8"><div className="max-w-[720px] reveal">
        ...
        <div className="mt-9 flex flex-wrap gap-3"><ButtonLink href="/games" testId="button-play-demo">Play Demo <ArrowRight size={16} /></ButtonLink><ButtonLink href="/wallet" variant="quiet" testId="button-open-wallet">Wallet</ButtonLink><WalletAuthButton /></div>
