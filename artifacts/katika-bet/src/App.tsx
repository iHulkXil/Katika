  ...
  return <div className="overflow-hidden">
    ...
    <section className="relative min-h-[680px] border-b border-border/70 surface-grid">
      ...
      <div className="relative mx-auto flex min-h-[680px] max-w-[1240px] items-center px-5 pb-12 pt-28 lg:px-8"><div className="max-w-[720px] reveal">
        ...
        <div className="mt-9 flex flex-wrap gap-3"><ButtonLink href="/games" testId="button-play-demo">Play Demo <ArrowRight size={16} /></ButtonLink><WalletAuthButton /></div>
...
function Wallet() { return <><PageIntro eyebrow="03 / WALLET" title="Your wallet, on your terms." description="Use Privy to connect a wallet identity to Katika.Bet. There are no balances, transactions, deposits, or withdrawals in this sprint." /><div className="mx-auto max-w-[1240px] px-5 py-14 lg:px-8"><div className="max-w-lg rounded-2xl border border-border bg-card p-8 sm:p-12"><div className="grid h-12 w-12 place-items-center rounded-xl bg-accent text-primary"><WalletCards size={22} /></div><h2 className="mt-7 text-2xl font-semibold tracking-[-.04em]">Wallet connection</h2><p className="mt-3 text-sm leading-7 text-muted-foreground">Connect or disconnect your wallet using Privy. Financial functionality is not active.</p><div className="mt-7"><ConnectedWalletStatus /></div></div></div></>; }
